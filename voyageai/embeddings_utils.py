...
def get_embedding(text: str, engine="voyage-api-v0", **kwargs) -> List[float]:
    ...
    return voyageai.Embedding.create(input=[text], engine=engine, **kwargs)["data"][0]["embedding"]
...
async def aget_embedding(text: str, engine="voyage-api-v0", **kwargs) -> List[float]:
    ...
    return (await voyageai.Embedding.acreate(input=[text], engine=engine, **kwargs))["data"][0][
        "embedding"
    ]
...
def get_embeddings(list_of_text: List[str], engine="voyage-api-v0", **kwargs) -> List[List[float]]:
    ...
    data = voyageai.Embedding.create(input=list_of_text, engine=engine, **kwargs).data
